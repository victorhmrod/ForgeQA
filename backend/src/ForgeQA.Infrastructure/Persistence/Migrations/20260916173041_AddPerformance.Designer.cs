...
namespace ForgeQA.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916173041_AddPerformance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForgeQA.Domain.Entities.TelemetryEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TelemetrySessionId", "EventName");
            ...
            modelBuilder.Entity("ForgeQA.Domain.Entities.TelemetrySession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProjectId", "RuntimeSessionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ForgeQA.Domain.Entities.TelemetrySession", b =>
                {
                    ...
                    b.OwnsOne("ForgeQA.Domain.Entities.TelemetrySessionEnvironment", "Environment", b1 =>
                        {
                            b1.Property<Guid>("TelemetrySessionId")
                                .HasColumnType("uuid");

                            b1.Property<string>("Configuration")
                                .HasMaxLength(50)
                                .HasColumnType("character varying(50)")
                                .HasColumnName("Environment_Configuration");
                            ...
                            b1.HasKey("TelemetrySessionId");

                            b1.ToTable("TelemetrySessions");
